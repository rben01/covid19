...
:timeline-video-dir: {fig-dir}/Geo/BokehInteractiveStatic
// Icons for sections
:icon-setup: 🛠
:icon-data: 💾
:icon-sources: 🚰
...
You can also view these timelines as non-interactive videos here: +
link:{timeline-video-dir}/countries_total_interactive.mp4[1. World/Cumulative], link:{timeline-video-dir}/countries_diff_interactive.mp4[2. World/Daily Differences], link:{timeline-video-dir}/usa_states_total_interactive.mp4[3. USA/Cumulative], link:{timeline-video-dir}/usa_states_diff_interactive.mp4[4. USA/Daily Differences].
--
...
[IMPORTANT,role="insufficient-width-warning"]
--
