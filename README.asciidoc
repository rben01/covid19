...
You can use the arrows to display lower- or higher-ranked locations. +
...
Hover your mouse over a row in the legend to select an individual region to view in the chart.
[[sect-line-chart]]
==== Chart
