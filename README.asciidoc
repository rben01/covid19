...
This section contains four interactive 2x2 grid-plots: two for the U.S. and two for the world's countries.
Both grid-plots have four quadrants showing how the number of cases and deaths, total and per capita, has progressed in the 48 continental U.S. states and Washington, D.C.
...
Hovering your cursor over a state will show its data for the selected date.
