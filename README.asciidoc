...
This section contains a single video showing the number of new cases and deaths, total and per capita, in the 48 continental US states and Washington D.C. States that are white on a given day had no new cases/deaths that day.

video::{timeline-video-dir}/dod_diffs.mp4[poster="{timeline-video-dir}/DayOverDayDiffs/dod_diff_20200419.png",options="loop"]
