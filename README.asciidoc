...
:email: {github-profile}[{github-icon-in-link}]{github-profile}[rben01]
...
TIP: The data used to create these graphs has been aggregated into a single table available {data-table-source}[here].
