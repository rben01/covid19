...
The colorbars are logarithmically scaled, which means moving a fixed distance along the colorbar represents multiplying by a fixed number.
...
video::{timeline-video-dir}/dod_diffs.mp4[role="usa-states-timeline-video-1",poster="{timeline-video-dir}/DayOverDayDiffs/dod_diff_20200419.png",options="loop"]
