...
This section contains a single video showing the number of new cases and deaths, total and per capita, in the 48 continental U.S. states and Washington, D.C.
