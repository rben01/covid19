...
image::{fig-dir}/{total-count-dir}/{since-outbreak-dir}/{stage-deaths-dir}/{img-countries}[{countries}{sep}{deaths-since-25}]
...
image::{fig-dir}/{total-count-dir}/{since-outbreak-dir}/{stage-deaths-dir}/{img-usa-states}[{usa-states}{sep}{deaths-since-25}]
