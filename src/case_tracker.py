...
def _get_data(*, from_web: bool) -> pd.DataFrame:
    ...
    :param from_web: Whether to refresh data by pulling from the web, or just use locally cached
    :type from_web: bool
    :return: The data
    :rtype: pd.DataFrame
    """
...
def main(namespace: argparse.Namespace = None) -> pd.DataFrame:
    ...
    :param namespace: The namespace generated by `argparse`; if `None`, default values
    will be used instead, by default None, defaults to None (default behavior will be used)
